...
func Test_markInventory(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:    []string{"Pink Shirt", "Red Shirt"},
			want:    []string{"Pink Shirt Size: 1", "Pink Shirt Size: 2", "Pink Shirt Size: 3", "Pink Shirt Size: 4", "Pink Shirt Size: 5", "Red Shirt Size: 1", "Red Shirt Size: 2", "Red Shirt Size: 3", "Red Shirt Size: 4", "Red Shirt Size: 5"},
			wantErr: nil,
		},
	}
