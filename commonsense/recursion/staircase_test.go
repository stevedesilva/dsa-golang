...
func Test_countNumberOfSteps(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equalf(t, tt.want, CountNumberOfPaths(tt.number), "CountNumberOfPaths(%v)", tt.number)
		})
	}
}
func Test_countNumberOfStepsAlternative(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equalf(t, tt.want, CountNumberOfPathsAlt(tt.number), "CountNumberOfPathsAlt(%v)", tt.number)
		})
	}
}
